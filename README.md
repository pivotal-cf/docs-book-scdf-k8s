...
+ Content repo: https://github.com/pivotal-cf/docs-spring-cloud-dataflow-k8s
+ Book repo (this one): https://github.com/pivotal-cf/docs-book-scdf-k8s
+ Pipeline: https://wings.concourse.ci/teams/cf-docs/pipelines/cf-services?groups=scdf-k8s

## What's in This Repo

Here you'll find the configuration and templates for the Pivotal SCDF for K8s documentation.
